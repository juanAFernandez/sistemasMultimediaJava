...
/**
 * Herramienta que filtra la imagen conseiguiendo detectar los bordes o fronteras.
 * Realiza la detección de fronteras de color o bordes mediante la aplicación de una operación de convolución
 * y un kernel, al igual que otras de la librería. En este caso se ha utilizado KernelProducer.TYPE_LAPLACIANA_3x3
