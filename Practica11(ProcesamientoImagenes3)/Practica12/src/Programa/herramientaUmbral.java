 ...
 * @author juan
 */
public class herramientaUmbral extends javax.swing.JFrame {
     ...
     */
    public herramientaUmbral(VentanaPrincipal padre) {
        initComponents();
    ...
    private void aplicar(int umbral){
        
        
        try{ 
                         
            
                UmbralizacionOp umbralOp = new UmbralizacionOp(255);
    ...
    private void jSlider1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSlider1StateChanged
        aplicar(this.jSlider1.getValue());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(herramientaUmbral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        /*
