...
public class Lienzo extends javax.swing.JPanel {
    ...
    */
    ...
    private void setAtributos(Graphics2D g2d){
        ...
        /*
        Sólo de la pŕactica 6. Vamos a probar los 7 atributos que pueden cambiar las figuras de forma estática aplicándolos
        sobre figuras estáticas que definiremos y después si dibujamos algo como lo hacíamos hasta ahora en tiempo de ejecución
        entonces veremos todas estas transformaciones juntas por lo que el resultado puede confundir un poco.
        */
        
        //Trazo:
        Stroke trazo;
        float patronDiscontinuidad[] = {15.0f, 15.0f};        
        trazo = new BasicStroke(10.f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER, 1.0f, patronDiscontinuidad, 0.0f);                        
        g2d.setStroke(trazo);        
