...
//        this.lienzo1.setGrosorLinea(10);
    ...
    private void initComponents() {
        ...
        ventanaHerramientaEmborronamiento.setMaximumSize(new java.awt.Dimension(500, 2147483647));
        ventanaHerramientaEmborronamiento.setMinimumSize(new java.awt.Dimension(500, 237));
        ventanaHerramientaEmborronamiento.setPreferredSize(new java.awt.Dimension(543, 400));
